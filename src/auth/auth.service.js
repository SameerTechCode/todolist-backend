...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(usersService, jwt) {
            this.usersService = usersService;
            this.jwt = jwt;
        }
        AuthService_1.prototype.signUp = function (email, password) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.usersService.create(email, passwordHash)];
                        case 3:
                            user = _a.sent();
