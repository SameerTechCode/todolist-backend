...
var Todo = function () {
    ...
    var Todo = _classThis = /** @class */ (function () {
        function Todo_1() {
            ...
            this.user = (__runInitializers(this, _completed_extraInitializers), __runInitializers(this, _user_initializers, void 0));
    ...
    (function () {
        ...
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return user_entity_1.User; }, function (user) { return user.todos; }, { onDelete: 'CASCADE' })];
